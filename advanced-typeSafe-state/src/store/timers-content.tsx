...
/*
    A better approach of handling this logic in every component
    that needs to consume this context.
    An alternative way could be: const timersCtx = useContext(TimersContext)!
    in every component
 */
